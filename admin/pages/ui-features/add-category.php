          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="Category">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="../../pages/ui-features/Add view.php">Add View</a>
                  </li>
                </ul>
              </div>
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="Product">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="../../pages/ui-features/Add-category.php">Add Product</a>
                  </li>
                 
                  <li class="nav-item">
                    <a class="nav-link" href="../../pages/ui-features/typography.php">Add Product</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="employee">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="../../pages/ui-features/buttons.php">Add employee</a>
                  </li>
                 
                  <li class="nav-item">
                    <a class="nav-link" href="../../pages/ui-features/typography.php">Add employee</a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="Customer">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="../../pages/ui-features/typography.php">Add Customer </a>
                  </li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
              ...
              <div class="collapse" id="orders">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item">
                    <a class="nav-link" href="../../pages/ui-features/buttons.php">Add orders</a>
                  </li>
                 
                  <li class="nav-item">
                    <a class="nav-link" href="../../pages/ui-features/typography.php">Add orders</a>
                  </li>
                </ul>
              </div>
            </li>
